...
- Catalog mock data note: `components/mega-menu-columns.ts` is still mock UI awaiting public catalog endpoints; product, category, option (size/color), comment, cart, address, shipping and order data all come from the API.
