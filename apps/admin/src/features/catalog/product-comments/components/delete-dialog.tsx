...
import { useDeleteProductComment } from '../hooks/use-product-comment-mutations'

type ProductCommentDeleteDialogProps = {
  open: boolean
...
export function DeleteDialog({
  ...
  onOpenChange,
  currentRow,
}: ProductCommentDeleteDialogProps) {
  ...
  const handleDelete = () => {
    ...
    deleteProductComment.mutate({ comment: currentRow })
  }
        ...
        <div className='space-y-4'>
          ...
          <Label className='my-2'>
            ...
            <Input
              ...
              placeholder={t('dialog.delete.enter_to_confirm', {
                word: currentRow.id.toString(),
              })}
            />
          </Label>
