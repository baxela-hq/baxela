...
import { useDeleteAttributeTemplate } from '../hooks/use-attribute-template-mutations'
...
export function DeleteDialog({
  ...
  const deleteAttributeTemplate = useDeleteAttributeTemplate()
  ...
  const handleDelete = () => {
    ...
    deleteAttributeTemplate.mutate(currentRow)
  }
