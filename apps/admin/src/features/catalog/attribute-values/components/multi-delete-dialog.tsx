...
import { deleteAttributeValue } from '../api/attribute-values.api'
    ...
    toast.promise(
      (async () => {
        for (const row of selectedRows) {
          const item = row.original as AttributeValue
          await deleteAttributeValue(attributeId, item.id.toString())
        }
      })(),
      {
