...
type DataTableProps = {
  data: PaginatedResponse<AttributeValue>,
  search: Record<string, unknown>
  navigate: NavigateFn
  attributeId: string
}

export function DataTable({ data, search, navigate, attributeId }: DataTableProps) {
  ...
  return (
    ...
    >
      ...
      <DataTableBulkActions table={table} attributeId={attributeId} />
    </div>
  )
}
