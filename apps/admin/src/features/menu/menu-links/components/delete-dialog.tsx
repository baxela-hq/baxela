...
import { useDeleteMenuLink } from '../hooks/use-menu-link-mutations'
...
export function DeleteDialog({
  ...
  const { tHelpText } = useAppTranslation(Locales.MENU_LINK)
  ...
  const handleDelete = () => {
    ...
    deleteMenuLink.mutate({ menuId, link: currentRow })
  }
