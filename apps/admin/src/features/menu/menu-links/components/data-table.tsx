...
import { type MenuLink } from '../data/schema.ts'
...
type DataTableProps = {
  data: PaginatedResponse<MenuLink>,
  search: Record<string, unknown>
  navigate: NavigateFn
  menuId: string
}

export function DataTable({ data, search, navigate, menuId }: DataTableProps) {
