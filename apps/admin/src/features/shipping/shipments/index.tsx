...
import { useShipmentsList } from './hooks/use-shipments';
import { useAppTranslation } from '@/hooks/useAppTranslation'

const route = getRouteApi('/_authenticated/shipping/shipments/')
...
export function Shipments() {
  ...
  const {data, isLoading, isSuccess} = useShipmentsList(search);
