...
import { useMethodsList } from './hooks/use-methods';
import { useAppTranslation } from '@/hooks/useAppTranslation'

const route = getRouteApi('/_authenticated/shipping/methods/')
...
export function Methods() {
  ...
  const {data, isLoading, isSuccess} = useMethodsList(search);
