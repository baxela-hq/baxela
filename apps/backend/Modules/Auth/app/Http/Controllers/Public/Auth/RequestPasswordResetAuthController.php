...
use Modules\Auth\Actions\Public\Auth\RequestPasswordResetAction;
...
class RequestPasswordResetAuthController extends Controller
{
     ...
     */
    public function __invoke(RequestPasswordResetOtpRequest $request, RequestPasswordResetAction $action): DefaultResource
    {
